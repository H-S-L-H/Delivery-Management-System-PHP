      ...
      <div class="table-responsive">
          <table class="table text-center align-middle table-hover mb-3">
              ...
              <?php
                ...
                $result_count = $mysqli->query("SELECT COUNT(*) as total_records FROM contactus");
                ...
                $sql = "SELECT * FROM contactus ORDER BY id DESC LIMIT $offset, $total_records_per_page";
              ...
              ?>
                    ...
                    <tr class="text-white">
                      ...
                      <td><?php echo strlen($row["contact_description"]) > 30 ? substr($row["contact_description"],0,30)."..." : $row["contact_description"]; ?></td>
                      <td>
                        <a href="contact_details.php?id=<?= $row["id"] ?>" class="btn btn-sm" data-bs-toggle="tooltip" title="View Detail"><i class="fa-solid fa-eye" style="background-color: white; padding: 10px; border-radius: 50%; color: green;"></i></a>
                          ...
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-footer text-body">
                                ...
                                <a href="contact_delete.php?id=<?= $row["id"] ?>" class="btn btn-primary">Delete</a>
                              </div>
                            </div>
                          </div>
                        </div>
